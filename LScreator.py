...
def vault(util,x,y):
    if util.lower() == 'b':
        ...
        vlbl = 'HW'
    v1 = graph.draw_rectangle((x-0.7, y-0.4), (x+0.7, y+0.4), line_color='black', fill_color=None)
...
def digbox(x1, y1, x2, y2):
    db=graph.draw_rectangle((x1, y1), (x2,y2), fill_color='gray')
    graph.TKCanvas.itemconfig(db, stipple = 'gray12')
...
cable(0,3,24,3)
digbox(0,7,24,16)
print(graph.get_figures_at_location((5,2.5)))
