...
tab1layout = [[sg.B("Read template", enable_events=True, k="read_file")]]
lcol = [
    [notify_inputmode],
    [sg.TabGroup([[sg.Tab("SketchBuilder", tab1layout)]], visible=True)],
]
...
layout = [[sg.Column(lcol), sg.Menu(menu_def), sg.Column(col)]]
